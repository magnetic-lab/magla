...
# Create Machine
current_machine = r.create(
    magla.Machine,
    {
        "facility_id": facility.id,
        "uuid": magla.Machine.generate_uuid()
    }
)

# Create Project
test_project = r.create(
    magla.Project,
    {
        "name": "test_project",
...
# create modo tool (and initial `MaglaToolVersion`)
modo_14_1v1 = r.create(
    magla.Tool,
    {
        "tool_name": "modo",
...
# create new tool version for `Modo`
modo_14_1v2 = r.create(
    magla.ToolVersion,
    {
